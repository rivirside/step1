...
const endocrineDiseases = [
    ...
    { id: "pheochromocytoma", name: "Pheochromocytoma", system: "endocrine", categories: ["adrenal-disorders"], severity: "high", acuity: "acute", tags: ["catecholamines", "5-Ps", "VMA-HVA"], pageType: "disease", detail: { definition: "Catecholamine-secreting tumor of adrenal medulla (90%) or extra-adrenal paraganglia (10%). Rule of 10s: 10% bilateral, 10% malignant, 10% extra-adrenal, 10% familial (MEN 2A/2B, VHL, NF1, SDH mutations). 5 P's: Pressure (episodic HTN), Pain (headache), Perspiration, Palpitations, Pallor. Triad: headache, palpitations, diaphoresis with HTN. ↑ plasma/urine metanephrines (most sensitive), ↑ VMA/HVA. CT/MRI adrenals, MIBG scan. Treat: alpha blockade (phenoxybenzamine) BEFORE beta blockade (prevent unopposed alpha → HTN crisis), then surgical resection. Screen family members.", overview: "[Content coming soon]" } },
    { id: "men-syndromes", name: "Multiple Endocrine Neoplasia (MEN) Syndromes", system: "endocrine", categories: ["pituitary-disorders", "thyroid-disorders", "adrenal-disorders"], severity: "high", acuity: "chronic", tags: ["AD", "familial", "tumors"], pageType: "disease", detail: { definition: "Inherited tumor syndromes (AD). MEN 1 (Wermer - MEN gene): 3 P's - Parathyroid adenoma (hyperparathyroidism - most common), Pancreatic islet tumors (gastrinoma, insulinoma), Pituitary adenoma (prolactinoma). MEN 2A (Sipple - RET): Medullary thyroid cancer (100%, ↑ calcitonin), Pheochromocytoma (50%), Hyperparathyroidism (20-30%). MEN 2B (RET): Medullary thyroid cancer, Pheochromocytoma, Mucosal neuromas, Marfanoid habitus. Screen: genetic testing if family history, monitor calcitonin (MTC), metanephrines (pheo), Ca/PTH. Treat: prophylactic thyroidectomy in MEN 2 if RET mutation.", overview: "[Content coming soon]" } },
    { id: "conn-syndrome", name: "Conn Syndrome (Primary Hyperaldosteronism)", system: "endocrine", categories: ["adrenal-disorders"], severity: "medium", acuity: "chronic", tags: ["HTN", "hypokalemia", "aldosterone"], pageType: "disease", detail: { definition: "Excess aldosterone. Causes: adrenal adenoma (Conn syndrome, 35%), bilateral adrenal hyperplasia (60%). HTN (resistant, no edema), hypokalemia (weakness, polyuria, polydipsia), metabolic alkalosis. ↑ aldosterone, ↓ renin, ↑ aldo:renin ratio (screening test >20). CT adrenals, adrenal vein sampling (lateralize if surgery planned). Treat: adrenal adenoma → surgical resection. Bilateral hyperplasia → spironolactone or eplerenone (aldosterone antagonists).", overview: "[Content coming soon]" } },
    { id: "acromegaly", name: "Acromegaly", system: "endocrine", categories: ["pituitary-disorders"], severity: "medium", acuity: "chronic", tags: ["GH", "IGF-1", "gigantism"], pageType: "disease", detail: { definition: "Excess GH, usually from pituitary adenoma. Adults: acromegaly (↑ hands/feet/jaw size, frontal bossing, macroglossia, arthropathy). Children (before epiphyseal closure): gigantism (tall stature). Complications: HTN, DM, cardiomyopathy, OSA, colon polyps/cancer, arthritis, carpal tunnel. ↑ IGF-1 (screening), GH not suppressed by oral glucose tolerance test (diagnostic - normally GH <1 after glucose load). MRI pituitary: macroadenoma. Treat: transphenoidal surgery (first-line), somatostatin analogs (octreotide, lanreotide), GH receptor antagonist (pegvisomant), dopamine agonist (cabergoline) if mixed GH-prolactin tumor.", overview: "[Content coming soon]" } },
    { id: "secondary-hyperaldosteronism", name: "Secondary Hyperaldosteronism", system: "endocrine", categories: ["adrenal-disorders"], severity: "medium", acuity: "chronic", tags: ["renin", "aldosterone", "edema"], pageType: "disease", detail: { definition: "↑ Aldosterone due to ↑ renin (vs primary where renin is suppressed). Causes: renal artery stenosis, CHF, cirrhosis, nephrotic syndrome, diuretics. Edema common (vs primary). ↑ aldosterone, ↑ renin (vs primary: ↓ renin). Treat underlying cause. Renal artery stenosis: angioplasty/stenting or surgery if appropriate. CHF/cirrhosis: manage volume status, consider aldosterone antagonist.", overview: "[Content coming soon]" } }
];
