...
const hematologyOncologyDiseases = [
    ...
    },
    {
        ...
        system: "hematology-oncology",
        categories: ["thrombotic-disorders"],
        symptoms: ["dyspnea", "chest-pain", "tachypnea", "tachycardia", "hemoptysis"],
        tags: ["thrombosis", "venous", "VTE", "pulmonary"],
        severity: "high",
        acuity: "acute",
        pageType: "disease",
        detail: {
            definition: "Obstruction of pulmonary arteries by thromboemboli, most commonly from deep vein thrombosis in the legs, leading to impaired gas exchange and potential hemodynamic compromise.",
            pathophysiology: "DVT embolizes to lungs → pulmonary artery obstruction → V/Q mismatch (ventilation without perfusion) → hypoxemia. Large PE: ↑ RV afterload → RV strain/failure → ↓ cardiac output → hemodynamic instability. Alveolar dead space + hypoxemia → tachypnea.",
            epidemiology: "Incidence 1/1,000 per year. Third most common acute cardiovascular disease. 50% of untreated DVT embolize. Mortality: untreated 30%, treated <5%. Massive PE mortality 25-50%.",
            riskFactors: [
                "Same as DVT (Virchow's triad): immobility, surgery, malignancy, pregnancy, OCPs, thrombophilia",
                "Prior VTE (strongest predictor)",
                "Most PE arise from proximal DVT (femoral, iliac)"
            ],
            presentation: "Dyspnea (most common), pleuritic chest pain, tachypnea, tachycardia. Hemoptysis (pulmonary infarction). Syncope (massive PE with hemodynamic compromise). May be asymptomatic if small PE.",
            physicalExam: [
                "Tachypnea (>20 breaths/min) - most common sign",
                "Tachycardia (>100 bpm)",
                "Hypoxemia (low O2 sat), but normal O2 sat does NOT exclude PE",
                "Hypotension (massive PE with RV failure)",
                "Signs of RV strain: JVD, loud P2, RV heave, tricuspid regurgitation murmur",
                "Low-grade fever",
                "Signs of DVT: unilateral leg swelling (50% have DVT on imaging even if asymptomatic)"
            ],
            diagnosticCriteria: "Clinical probability (Wells score or PERC rule) + D-dimer (if low-intermediate probability) + CT pulmonary angiography (CTPA, gold standard).",
            labs: [
                "D-dimer: rule OUT test (same as DVT). Negative D-dimer + low pretest probability → PE excluded.",
                "ABG: hypoxemia, hypocapnia (respiratory alkalosis from tachypnea), A-a gradient ↑",
                "  - Normal ABG does NOT rule out PE",
                "Troponin, BNP: elevated if RV strain (prognostic, indicates worse outcome)",
                "Wells score for PE: risk stratifies",
                "  - Clinical signs of DVT (+3), alternative diagnosis less likely than PE (+3)",
                "  - HR >100 (+1.5), immobilization/surgery in past 4 weeks (+1.5)",
                "  - Prior VTE (+1.5), hemoptysis (+1), malignancy (+1)",
                "  - Score: <2 = low, 2-6 = moderate, >6 = high",
                "PERC rule (Pulmonary Embolism Rule-out Criteria): if ALL negative, PE unlikely (<2%) - no further testing",
                "  - Age <50, HR <100, O2 sat >94%, no hemoptysis, no estrogen use, no prior VTE, no unilateral leg swelling, no surgery/trauma in past 4 weeks"
            ],
            imaging: [
                "CT pulmonary angiography (CTPA) - gold standard:",
                "  - Sensitivity/specificity >90%",
                "  - Shows filling defects in pulmonary arteries",
                "  - Also evaluates for alternative diagnoses (pneumonia, aortic dissection)",
                "V/Q scan: if CTPA contraindicated (contrast allergy, renal failure, pregnancy)",
                "  - High probability V/Q scan + high clinical suspicion → treat for PE",
                "  - Low probability V/Q scan + low clinical suspicion → PE excluded",
                "  - Indeterminate scans common (50%) → need further testing",
                "Echocardiography: RV strain (RV dilation, septal flattening, McConnell's sign = RV free wall hypokinesis with apical sparing)",
                "  - Used for risk stratification, not diagnosis",
                "  - Massive PE: RV dysfunction on echo → high-risk",
                "Lower extremity Doppler: if positive for DVT + clinical suspicion for PE → treat for PE (no need for CTPA)",
                "Pulmonary angiography: gold standard but invasive, rarely used"
            ],
            differentialDiagnosis: [
                "ACS/MI: chest pain, troponin elevation, ECG changes (but PE can also have troponin elevation)",
                "Pneumonia: fever, productive cough, infiltrate on CXR",
                "Pneumothorax: sudden dyspnea, absent breath sounds, CXR diagnostic",
                "Aortic dissection: tearing chest pain, BP differential, widened mediastinum",
                "Heart failure exacerbation: gradual dyspnea, pulmonary edema on CXR, BNP elevated",
                "Pericarditis: pleuritic chest pain, pericardial rub, diffuse ST elevation",
                "Anxiety/panic attack: dyspnea, chest pain, but no objective findings"
            ],
            management: {
                acute: [
                    ...
                    "    • LMWH (enoxaparin) → warfarin bridge (INR 2-3)",
                    "    • Unfractionated heparin IV (if unstable, renal failure, or need for procedures)",
                    "Massive PE (hypotension, shock, cardiac arrest):",
                    "  - Systemic thrombolysis: alteplase (tPA) 100 mg IV over 2 hours",
                    "    • Indications: hemodynamic instability (SBP <90 mmHg, vasopressors)",
                    "    • Contraindications: active bleeding, recent surgery, stroke, head trauma",
                    "    • Mortality benefit in massive PE",
                    "  - Surgical embolectomy or catheter-directed thrombolysis if thrombolysis contraindicated",
                    "Submassive PE (normotensive but RV strain on echo or troponin/BNP elevation):",
                    "  - Anticoagulation (controversial whether to give thrombolytics - higher bleeding risk, debated benefit)",
                    "  - Consider thrombolysis if high-risk features (severe RV dysfunction, significant troponin rise)",
                    "Supportive care:",
                    "  - Supplemental O2 for hypoxemia",
                    "  - IV fluids (avoid overload - can worsen RV failure)",
                    "  - Vasopressors if shock (norepinephrine preferred)",
                    "IVC filter: if absolute contraindication to anticoagulation"
                ],
                chronic: [
                    "Duration same as DVT:",
                    "  - Provoked: 3 months",
                    "  - Unprovoked: minimum 6 months, consider indefinite",
                    "  - Cancer-associated: LMWH preferred, continue while cancer active",
                    "  - Recurrent VTE: indefinite anticoagulation",
                    "Thrombophilia workup if unprovoked or recurrent",
                    "Monitor for chronic thromboembolic pulmonary hypertension (CTEPH): persistent dyspnea, RV failure months-years after PE",
                    "  - Diagnosis: V/Q scan (more sensitive than CTPA for chronic PE), right heart catheterization",
                    "  - Treatment: pulmonary thromboendarterectomy (potentially curative)"
                ]
            },
            complications: [
                "Death (30% if untreated, <5% if treated, 25-50% for massive PE)",
                "Chronic thromboembolic pulmonary hypertension (CTEPH): 2-4%, develops months-years after PE",
                "Recurrent VTE (10% per year if unprovoked and off anticoagulation)",
                "Bleeding from anticoagulation or thrombolysis",
                "Post-PE syndrome: chronic dyspnea, reduced exercise tolerance"
            ],
            prognosis: "Treated PE: mortality <5%. Massive PE: mortality 25-50% even with treatment. CTEPH develops in 2-4%. Recurrence risk high in unprovoked PE (10% per year off anticoagulation).",
            clinicalPearls: [
                "PE = DVT that traveled to the lungs. 90% of PE arise from proximal leg DVT.",
                "Classic triad: dyspnea, pleuritic chest pain, hemoptysis - present in <20% of cases",
                "Most common sign: tachypnea. Most common symptom: dyspnea.",
                "D-dimer: rule OUT test. Negative D-dimer + low Wells score → PE excluded (>99% NPV).",
                "PERC rule: if all 8 criteria negative → PE risk <2%, no further testing needed",
                "Wells score >6 OR hemodynamic instability → skip D-dimer, go straight to CTPA",
                "ECG in PE: sinus tachycardia (most common). Classic S1Q3T3 pattern rare (20%), suggests RV strain.",
                "Hampton's hump (wedge-shaped opacity), Westermark sign (oligemia) on CXR are rare and non-specific",
                "Massive PE = hemodynamic instability (SBP <90, shock) → give thrombolytics (alteplase)",
                "Submassive PE = normotensive but RV strain (echo, troponin/BNP) → anticoagulation, consider thrombolytics if high-risk",
                "Thrombolysis contraindications: active bleeding, recent surgery/stroke, brain tumor, head trauma",
                "DOACs preferred over warfarin (no monitoring, easier dosing). LMWH preferred if cancer or pregnancy.",
                "Saddle PE: large thrombus at bifurcation of main pulmonary artery. Often massive.",
                "RV strain on echo = poor prognosis (higher mortality). McConnell's sign: RV free wall hypokinesis, apex spared.",
                "CTEPH: chronic dyspnea after PE. Diagnose with V/Q scan. Potentially curable with pulmonary thromboendarterectomy.",
                "Pregnancy: use LMWH (heparin doesn't cross placenta, warfarin is teratogenic). CTPA or V/Q scan acceptable for diagnosis.",
                "IVC filter: does NOT treat PE or prevent DVT, only prevents future embolization. Only use if anticoagulation contraindicated."
            ]
        }
    },
    {
